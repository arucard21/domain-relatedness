...
//        generateColumnLevelDomainsWithImprovedSimilarity();
//        generateColumnLevelDomainsWithImprovementsAndFilteredDatasets();
//        generateColumnLevelDomainsWithImprovementsAndOnlyImdbDataset();
//        generateColumnLevelDomainsWithImprovementsAndOnlyTmdbFilteredDataset();
//        generateColumnLevelDomainsWithImprovementsWithoutRTDataset();
    }
    ...
    private static void generateColumnLevelDomainsWithImprovedSimilarity() {
		// ----------------------------------------------------------------
	    // GENERATE COLUMN FILES
	    // ----------------------------------------------------------------
		String pathPrefix = "output/improved-similarity/";
		new File(pathPrefix).mkdirs();
	    try {
	        new D4().columns(
	                new File("input", "data"),
...
//    private static void generateColumnLevelDomainsWithImprovementsAndFilteredDatasets() {
//		generateColumnLevelDomainsWithImprovements("input/filtered", "output/filtered/");
//	}
//
//    private static void generateColumnLevelDomainsWithImprovementsAndOnlyImdbDataset() {
//		generateColumnLevelDomainsWithImprovements("input/imdb", "output/imdb/");
//	}
//
//    private static void generateColumnLevelDomainsWithImprovementsAndOnlyTmdbFilteredDataset() {
//		generateColumnLevelDomainsWithImprovements("input/tmdb", "output/tmdb/");
//	}

	private static void generateColumnLevelDomainsWithImprovementsWithoutRTDataset() {
